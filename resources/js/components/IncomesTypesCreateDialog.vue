    ...
    >
        ...
        <v-card>
            ...
            >
                ...
                <v-toolbar-title> Добавление статьи прихода</v-toolbar-title>
                <v-spacer/>
                <v-btn
                    icon
                            ...
                            <v-col cols="12" class="pb-0 pt-1">
                                <v-text-field
                                    ...
                                    :rules="[
                                        ...
                                        v => incomes_types === null || incomes_types.find(el => el.name === v) === undefined || 'Такое название уже существует'
                                    ]"
                                    required
                                />
                            </v-col>
...
export default {
    ...
    methods: {
        ...mapActions('incomes_types', ["store"]),
        clearField() {
